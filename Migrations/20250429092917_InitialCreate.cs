        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapEmbedCode = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    FacebookUrl = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    TwitterUrl = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    InstagramUrl = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
